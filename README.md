...
2. Entre no diretório **/out/production/chess-system** do projeto.
3. Após entrar no diretório, digite `Java application/Program` para rodar a aplicação (obs: estou utilizando o Java SE 17)
